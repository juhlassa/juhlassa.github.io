...
export function vanilja(): RentalOrLinkedRentalItem[] {
  return [
    {
    ...
    },
    {
      ...
      volume: 1.8,
      pcs: 1,
      image: '/kuvat/vanilja/kannu-1.8.jpg',
      price: 0
    },
    {
    ...
    },
    {
      ...
      height: 5,
      pcs: 1,
      image: '/kuvat/vanilja/sydanlautanen-pentik.jpg',
      price: 0
    },
    {
      name: 'Sydän&shy;lautanen, kukka',
      diameter: 17,
      height: 5,
      pcs: 4,
...
export function vaniljaResolved() {
  return rentalItemsResolved(vanilja())
}
